...
//					new JTextField("输入框"),
//					b);
			AlertComponent ac=AlertFactory.createSuccessAlert("这是一条警告", true, true, X2Component.GrowStyle.LEFT_GROW);
			ac.setVisible(true);
			SwingTestUtil.test(AlertFactory.createSuccessAlert("这是一条警告", true, true, X2Component.GrowStyle.LEFT_GROW));
