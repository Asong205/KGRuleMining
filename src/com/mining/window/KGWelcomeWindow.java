...
import com.mining.window.component.JLinePanel;
import com.mining.window.component.JListItem;
import com.mining.window.enums.CloseAction;
import com.mining.window.layout.ListLayout;
import com.mining.window.service.KGWelcomeService;
...
public class KGWelcomeWindow extends AbstractWindow <KGWelcomeService>{
    public KGWelcomeWindow() {
        super("欢迎访问重症医疗规则提取系统", new Dimension(400, 500), false, KGWelcomeService.class);
        //设定窗口关闭行为为直接退出程序
    ...
    protected void initWindowContent() {
        ...
        this.addComponent("welcome.panel.top", new JPanel(), BorderLayout.NORTH, panel -> {
            ...
            this.addComponent(panel, "welcome.panel.top.top",
                    new JLinePanel(true), this::initContentTop);
            //下半部分是搜索框，这个就简单，价格搜索框就完事了
            this.addComponent(panel, "welcome.panel.top.bottom",
                    new JPanel(), this::initContentBottom);
        });
    ...
    private void initContentTop(JLinePanel top){
        top.setPreferredSize(new Dimension(200, 35));
...
//        });
    ...
    private void initContentBottom(JPanel bottom){
        ...
        //bottom.setPreferredSize(new Dimension(200,25));
        this.addComponent(bottom, "welcome.field.search", new JTextField(10),
    ...
    public void initProjectList(){
        ...
        ProjectManager.getManager().getProjectList()
                ...
                .forEach(proj -> this.addComponent(listPanel,   //JListItem使自己定义列表Item组件，很好看的
        ...
        StepsComponent c = new StepsComponent(Arrays.asList(" ", " ", " ", " "),
                ...
                0, ColorUtil.PRIMARY, 55, true);

        stepPanel.add(c);

        this.addComponent("welcome.step",stepPanel,BorderLayout.SOUTH,null);
    }
}
