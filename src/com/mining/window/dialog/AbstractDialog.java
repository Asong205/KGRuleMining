...
public abstract class AbstractDialog extends JDialog {
    ...
    /**
     * 一律只能用自己的openDialog()方法展示对话框，原本的可见性设置直接封掉
     */
    @Override
     ...
     * 要拿到窗口的位置，然后计算窗口的中心位置再减去对话框的尺寸，就是居中位置了
     * @return 对话框居中位置
     */
    ...
    protected <T extends Container> void addComponent(Container container,T component, Consumer<T> consumer){
        if(consumer != null)
            consumer.accept(component);
