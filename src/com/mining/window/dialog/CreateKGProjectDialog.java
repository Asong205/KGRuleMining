 ...
 * 项目创建对话框
 */
public class CreateKGProjectDialog extends AbstractDialog {
    private JTextField nameField;   //项目名称输入框
    private JTextField pathField;   //项目路径输入框
    private JTextField toolField;   //jar路径输入框
    ...
    private final KGWelcomeWindow parentWindow; //这里暂时存一下父窗口，后面方便一起关掉

    public CreateKGProjectDialog(KGWelcomeWindow parent){
    ...
    protected void initDialogContent() {
        ...
        //首先添加最左侧的标签
        this.addComponent(jPanel,new JLabel("项目名称："), label -> label.setBounds(20, 20, 100, 20));
        this.addComponent(jPanel,new JLabel("项目路径："), label -> label.setBounds(20, 60, 100, 20));
        this.addComponent(jPanel,new JLabel("项目工具："), label -> label.setBounds(20, 120, 100, 20));
        ...
        this.addComponent(jPanel,(finalPath = new JLabel("请填写项目名称和项目保存路径！")),
        ...
        //选择框
        this.addComponent(jPanel,new JComboBox<String>(), box -> {
...
//                box -> box.setBounds(100, 190, 200, 25));
        this.addComponent(jPanel,(createButton = new JButton("创建项目")), button -> {
            ...
            button.addActionListener(e -> {
                ...
                //打开项目编辑窗口
                KGWindow window = new KGWindow(name, path + "/" + name);
                window.openWindow();
            });
        });
    ...
    private void selectDirectory(){
        DirectoryChooserDialog directoryChooserDialog = new DirectoryChooserDialog(CreateKGProjectDialog.this);
