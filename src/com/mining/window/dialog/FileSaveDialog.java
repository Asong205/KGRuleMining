...
public class FileSaveDialog extends AbstractDialog {
    ...
    public FileSaveDialog(OutputWindow parent) {
...
//                box -> box.setBounds(100, 190, 200, 25))
        ...
        this.addComponent(jPanel,(createButton = new JButton("保存")), button -> {
            ...
            button.addActionListener(e -> {
                ...
                ETable table = parentWindow.getRuletable();
    ...
    private void selectDirectory() {
        DirectoryChooserDialog directoryChooserDialog = new DirectoryChooserDialog(FileSaveDialog.this);
