package com.mining.window.layout;
...
/**
 *  provides some extensions to the
 ...
 */
public class XCardLayout extends CardLayout implements HierarchyListener
{
     ...
     */
    public XCardLayout(int hgap, int vgap)
    {
        super(hgap, vgap);
    }
